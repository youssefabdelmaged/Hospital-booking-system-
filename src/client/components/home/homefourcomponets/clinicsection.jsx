    ...
    <div className="container">
        ...
        <div className="col-lg-3 col-md-4 aos" data-aos="fade-up">
            ...
            <div className="special-body">
                <img src={spec} alt="" />
                <h4>Orthopedic</h4>
                <Link to="/doctor/search-doctor2" className="spc-book">Book now <i className="fas fa-caret-right" /> </Link>
            </div>
        ...
        <Link to="doctor/search-doctor2" className="btn btn-primary">View More</Link>
        </div>
    </div>
    </section>
  );
